...
if __name__ == "__main__":
    ...
    print(f"Input shape: {torch.zeros((1, num_steps, encoding_dim)).shape}")
    print(f"Position encoding shape: {P.shape}")
    print(f"Output shape: {X.shape}")
    print("Position 0 first 8 dims:", P[0, 0, :8])
    print("Position 1 first 8 dims:", P[0, 1, :8])
